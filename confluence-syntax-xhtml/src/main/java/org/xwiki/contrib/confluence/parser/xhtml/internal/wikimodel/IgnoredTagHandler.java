...
/**
 * Handles macros that should be completely ignored.
 *
 * @version $Id$
 * @since 9.25.0
 */
public class IgnoredTagHandler extends AbstractRichContentTagHandler
{
    /**
     * @param parser is used to access the parser and the rendering to use to manipulate the content
     */
    public IgnoredTagHandler(ConfluenceXHTMLParser parser)
    {
        super(parser);
    }
